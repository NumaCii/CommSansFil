...
int main()
{
    ...
    memset(&MonLecteur, 0, sizeof(ReaderName));
    MonLecteur.Type = ReaderCDC;
    MonLecteur.device = 0;

    printf("ODALID SDK\n");
    printf("\n");
    printf("NXP MIFARE 'CLASSIC' 1k Lecture carte\n");
    printf("-----------------------------------------------\n");
    printf("https://odalid.com\n\n");

    GetLibraryCore(&MaLibVersionCore);
    printf("Version Librairie Core is %d.%d.%d\n", MaLibVersionCore.VMajor, MaLibVersionCore.VMinor, MaLibVersionCore.VPatch);
    GetLibraryExtension(&MaLibVersionExtension);
    printf("Version Librairie Extension is %d.%d.%d\n", MaLibVersionExtension.VMajor, MaLibVersionExtension.VMinor, MaLibVersionExtension.VPatch);
...
{
    ui->setupUi(this);  // charge le .ui

    // Ici tu branches tes boutons sur la logique MIFARE :
